...
<main class="cellier-page">
    ...
    @if (empty($query))
            ...
            <section>
                    <div> 
                        ...
                        <ul>Désolé, aucun résultat trouvé.
                            ...
                            <li>
                                <a href="{{ route('cellier_bouteilles.cellier.bouteilles', ['cellier_id' => session('id_cellier')]) }}">Ou retourner a ton cellier</a>
                            </li>
                        </ul>
                    </div>
            </section>
            ...
            @endif">
                ...
                <div>
                <a href="{{ route('cellier_bouteilles.cellier.bouteilles', ['cellier_id' => session('id_cellier')]) }}">Tous les resultats</a>
            </div>
